...
proxy_dct=pkl.load(open('good_data/San_Francisco/proxy_dct.pkl','rb'))
...
def get_route_geolocations(route):
    import pickle as pkl
    _, attr_by_geolocations = pkl.load(open('good_data/San_Francisco/important_items.pkl', 'rb'))
    hotels_index = pkl.load(open('good_data/San_Francisco/hotel_geocoords_dct.pkl', 'rb'))
